...
```text
$docs-fairy-site 기존 docs/를 보존하면서 Starlight 문서 사이트를 만들어줘
```
...
Source: [`plugins/nunch-skills/skills/docs-fairy-site/SKILL.md`](../../plugins/nunch-skills/skills/docs-fairy-site/SKILL.md)
