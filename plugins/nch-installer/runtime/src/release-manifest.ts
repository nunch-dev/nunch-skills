...
const pluginPath = 'plugins/nch-installer/.codex-plugin/plugin.json';
const hookPath = 'plugins/nch-installer/hooks/hooks.json';
const runtimePath = 'plugins/nch-installer/runtime/nch-installer.mjs';
const scriptPaths = ['plugins/nch-installer/scripts/node-dispatch.ps1'];
