...
const pluginPath = 'plugins/nunch-skills-manager/.codex-plugin/plugin.json';
const hookPath = 'plugins/nunch-skills-manager/hooks/hooks.json';
const runtimePath = 'plugins/nunch-skills-manager/runtime/nunch-skills-manager.mjs';
const scriptPaths = ['plugins/nunch-skills-manager/scripts/node-dispatch.ps1'];
