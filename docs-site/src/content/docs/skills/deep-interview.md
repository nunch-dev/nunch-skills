...
description: 모호한 요청을 승인 가능한 실행 스펙으로 정제하는 스킬
---
...
Source: [`plugins/nunch-skills/skills/deep-interview/SKILL.md`](https://github.com/nunch-dev/nunch-skills/blob/main/plugins/nunch-skills/skills/deep-interview/SKILL.md)
