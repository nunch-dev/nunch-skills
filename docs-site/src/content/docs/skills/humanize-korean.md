...
description: 의미를 보존하며 AI가 쓴 한국어를 자연스럽게 다듬는 스킬
---
...
```text
$humanize-korean 이 초안의 사실과 의미는 유지하고 AI 번역투만 자연스럽게 다듬어줘
```
...
Source: [`plugins/nunch-skills/skills/humanize-korean/SKILL.md`](https://github.com/nunch-dev/nunch-skills/blob/main/plugins/nunch-skills/skills/humanize-korean/SKILL.md)
